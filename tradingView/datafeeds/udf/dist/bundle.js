        ...
        _updateQuotes(updateType) {
            ...
            for (const listenerGuid in this._subscribers) {
                ...
                this._quotesProvider
                    .getQuotes(updateType === 1 /* SymbolsType.Fast */
                ...
                this._send('symbols', params)
                    ...
                    if (response.s !== undefined) {
                        ...
                        const result = {
                            ...
                            intraday_multipliers: (_y = (_x = response.intraday_multipliers) !== null && _x !== void 0 ? _x : response['intraday-multipliers']) !== null && _y !== void 0 ? _y : [
                                '1',
                                '5',
                                '15',
                                '30',
